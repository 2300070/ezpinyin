...
## 提示
本项目处于不停迭代中，若你使用过程中发现问题，建议升级到最新版本或提交新的异常报告。

## 特性

- 极快的处理速度，具体请参考性能章节。
- 涵盖统一码平面A的基本汉字区及补充汉字区、汉字扩展区A的全部汉字，涵盖统一码平面B的汉字扩展区B、C、D、E、F、G的大部分汉字，总计约覆盖九万汉字。
- 通过引入高质量的词典，使得此项目对于多音字有着不错的识别能力。
